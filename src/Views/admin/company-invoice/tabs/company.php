 ...
 * @author      arisciwek
 *
 * Path: /wp-customer/src/Views/admin/company-invoice/tabs/company.php
 *
 * Description: Company tab untuk company invoice detail panel.
 ...
 * - Lazy-load pattern
 * - AJAX endpoint: load_company_invoice_company_tab
 */
...
<div class="wpdt-tab-autoload"
     data-ajax-action="load_company_invoice_company_tab"
     data-invoice-id="<?php echo esc_attr($invoice->id); ?>">
    <div class="wpdt-tab-loading">
        <span class="spinner is-active"></span>
        <p><?php esc_html_e('Loading company information...', 'wp-customer'); ?></p>
    </div>
</div>
